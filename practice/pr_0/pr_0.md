Ниже представлено структурированное руководство **lab_0.md**, подготовленное специально для студентов МГПУ. Весь предоставленный материал сохранен в полном объеме и организован для удобного пошагового выполнения.

---

# Лабораторная работа №0: Знакомство с ClickHouse и анализ данных о такси Нью-Йорка
